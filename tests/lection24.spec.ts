...
test.describe('Field "Re-enter Password" tests', () => {
  ...
  test.beforeEach( async ({ page }) => {
    ...
    test('Passwords do not match error', async () => {
      await signUpForm.enterValuesAndTriggerErrorOnRepeatPasswordField('For_The_Horde99', 'For_The_Horde9');
...
test.describe('Button "Register" tests', () => {
  ...
  test.beforeEach( async ({ page }) => {
    ...
    test('Register button is disabled', async () => {
      await signUpForm.fillInRegisterForm('Nikita', 'Kaluhin', randomUserEmail, 'For_The_Horde99', 'For_The_Horde9');
      await signUpForm.verifyDisabledButton();
    })

    test('Successful Registration', async () => {
      await signUpForm.fillInRegisterForm('Nikita', 'Kaluhin', randomUserEmail, 'For_The_Horde99', 'For_The_Horde99');
